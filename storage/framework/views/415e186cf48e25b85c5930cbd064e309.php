        ...
        <div class="login">
            ...
            <div class="kontainer3">
                <div id="soal_1">
                    ...
                    <div id="btn">
                        <button>Next</button>
                        <button id="kembali" type="submit" id="submit" class="submit"><a href="./evaluasi">Kembali ke Menu</a></button>
                    </div>
                </div>
                <div id="soal_2">
                ...
                <div id="soal_3">
                    3.	Perangkat keras apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="<?php echo e(asset('images/perangkatInput/ROM-Drive.png')); ?>" alt="gambar rom-drive"><br>
                ...
                <div id="soal_9">
                    9.	Perangkat memory apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="<?php echo e(asset('images/perangkatMemory/ram.jpg')); ?>" alt="gambar ram"><br>
                ...
                <div id="soal_10">
                    10.	Perangkat memory apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="<?php echo e(asset('images/perangkatMemory/rom.jpeg')); ?>" alt="gambar rom"><br>
...
</script><?php /**PATH C:\xampp\htdocs\ProjekAkhirPEMWEB2\resources\views/soal.blade.php ENDPATH**/ ?>