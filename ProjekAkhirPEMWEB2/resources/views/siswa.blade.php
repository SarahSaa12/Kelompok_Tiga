                    ...
                    <div class="form">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="kotak" type="text" class="form-control @error('email') is-invalid @enderror" id="NIS" name="NIS" value="{{ old('email') }}">
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>                            
                            ...
                            <div class="mb-3">
                                ...
                                <input class="kotak" type="text" class="form-control @error('email') is-invalid @enderror" id="kelas" name="kelas" value="{{ old('email') }}">
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>                            
