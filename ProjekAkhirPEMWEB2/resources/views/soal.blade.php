...
<head>
    <title>Latihan</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/evaluasi.css') }}">
</head>
            ...
            <div class="kontainer3">
                ...
                <div id="soal_3">
                    3.	Perangkat keras apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="{{ asset('images/perangkatInput/ROM-Drive.png') }}" alt="gambar rom-drive"><br>
                ...
                <div id="soal_4">
                    4.	Gambar di bawah ini menunjukkan jenis koneksi perangkat keras apa?<br><br>
                        <img src="{{ asset('images/perangkatProses/VGA.png') }}" alt="gambar VGA">
                ...
                <div id="soal_9">
                    9.	Perangkat memory apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="{{ asset('images/perangkatMemory/ram.jpg') }}" alt="gambar ram"><br>
                ...
                <div id="soal_10">
                    10.	Perangkat memory apa yang ditunjukkan pada gambar di bawah ini?<br>
                        <img style="height: 70px" src="{{ asset('images/perangkatMemory/rom.jpeg') }}" alt="gambar rom"><br>
